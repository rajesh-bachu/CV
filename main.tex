...
%  \resumeSubHeadingListEnd
\begin{comment}
Maulik Shah is in his 13th year overall and 3rd year as a Senior Manager with Deloitte Consulting’s Analytic & Cognitive Practice, with primary focus on Big Data Modernization and Cloud Migration. As a hands-on Senior Manager and Architect, Maulik has managed and led end-to-end enablement of several large-scale (multi peta-byte, several simultaneous use-cases, large global/remote teams) DW/Data Lake/Data-as-a-Service and Cloud Native technology programs, from concept definition to implementation to operation and maintenance, for his clients he serves in Healthcare and Life Sciences industries.

Maulik is client-service and end-result focused leader, with a proven track-record of 13 years of professional services delivery excellence. He has exceeded year-end performance metrics and goals, including but not limited to managed revenue and primary sales, and has been consistently recognized with the highest year-end performance ratings in each of his 13 years with Deloitte Consulting.

Maulik is highly motivated and quick learner of new data/architecture patterns and frameworks, having advised c-level executives on evolving technology landscape and value to business, and partnered with large teams of technology colleagues to architect, design, develop, implement and operate sustainable and scalable technology solutions. He has passed several industry recognized exams/certifications and continues to learn and grow:

1. Business Analytics, Kelley School of Business
2. AWS Developer
3. AWS Solutions Architect Associate
4. AWS SysOps
5. Scrum Master
6. AWS BigData Specialist
7. AWS Cloud Practitioner
8. AWS Solutions Architect Pro
9. AWS DevOps Pro (scheduled)
10. AWS Machine Learning (scheduled)
11. Microsoft Azure Architect (considering)
12. Google Cloud Architect (considering)

Maulik has a Master’s in Computer Science and Bachelor’s in Information Technology. He is married and has a son. 
\end{comment}
%-------------------------------------------
